...
const Analytics = () => {
    ...
    return (
        <div className="space-y-12">
            <header>
                <h1 className="text-4xl font-black text-gsps-blue mb-2">Platform <span className="text-gsps-green">Analytics</span></h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {[
                    ...
                    <div key={i} className="bg-white p-8 rounded-[40px] shadow-sm border border-gray-100 group">
